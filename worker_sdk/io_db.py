...
class TaskRecord:
    """
    Persisted task row. Overlapping fields match :class:`worker_sdk.work_queue_message.WorkQueueMessage`
    (SQS body is validated with that type; do not duplicate wire shape elsewhere).
    """
